...
export default class CommunalSpaceMaintenance extends LightningElement {
    ...
    handleCommunitySelect(event) {
        ...
        getCommunalSpaces({ communityId: this.communityId }).then(result => {
    ...
    handleSpaceSelect(event) {
        ...
        getMaintenance({ communalSpaceId: this.communalSpaceId }).then(result => {
    ...
    async handleScheduleMaintenance() {
        ...
        getMaintenance({ communalSpaceId: result }).then(result2 => {
