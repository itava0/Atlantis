...
export default class MaintenanceModal extends LightningModal {
    ...
    async handleOkay() {
        await CreateCSMaintenance({ communalSpaceId: this.communalSpaceId, startDateTime: this.startDateTime, endDateTime: this.endDateTime, body: this.announcementDetails }).then(result => {
