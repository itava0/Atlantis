    ...
    populateMarkers() {
        ...
        if (this.hotels && this.hotelSelected && this.hotels.length > 0) {
            for (let i = 0; i < this.hotels.length; i++) {
                if (this.hotels[i].ratingNum > this.minRating && this.hotels[i].distance < this.maxDistance) {
                    this.mapMarkers.push({
                        location: {
        ...
        if (this.restaurants && this.restaurantSelected && this.restaurants.length > 0) {
            for (let i = 0; i < this.restaurants.length; i++) {
                if (this.restaurants[i].ratingNum > this.minRating && this.restaurants[i].distance < this.maxDistance) {
                    this.mapMarkers.push({
                        location: {
        ...
        if (this.airports && this.airportSelected && this.airports.length > 0) {
            for (let i = 0; i < this.airports.length; i++) {
                if (this.airports[i].ratingNum > this.minRating && this.airports[i].distance < this.maxDistance) {
                    this.mapMarkers.push({
                        location: {
        ...
        if (this.schools && this.schoolSelected && this.schools.length > 0) {
            for (let i = 0; i < this.schools.length; i++) {
                if (this.schools[i].ratingNum > this.minRating && this.schools[i].distance < this.maxDistance) {
                    this.mapMarkers.push({
                        location: {
        ...
        if (this.gyms && this.gymSelected && this.gyms.length > 0) {
            for (let i = 0; i < this.gyms.length; i++) {
                if (this.gyms[i].ratingNum > this.minRating && this.gyms[i].distance < this.maxDistance) {
                    this.mapMarkers.push({
                        location: {
        ...
        if (this.banks && this.bankSelected && this.banks.length > 0) {
            for (let i = 0; i < this.banks.length; i++) {
                if (this.banks[i].ratingNum > this.minRating && this.banks[i].distance < this.maxDistance) {
                    this.mapMarkers.push({
                        location: {
        ...
        if (this.hospitals && this.hospitalSelected && this.hospitals.length > 0) {
            for (let i = 0; i < this.hospitals.length; i++) {
                if (this.hospitals[i].ratingNum > this.minRating && this.hospitals[i].distance < this.maxDistance) {
                    this.mapMarkers.push({
                        location: {
        ...
        if (this.supermarkets && this.supermarketSelected && this.supermarkets.length > 0) {
            for (let i = 0; i < this.supermarkets.length; i++) {
                if (this.supermarkets[i].ratingNum > this.minRating && this.supermarkets[i].distance < this.maxDistance) {
                    this.mapMarkers.push({
                        location: {
